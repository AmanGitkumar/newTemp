...
const Signup = () => {
    ...
    return (
        <div className="signup-container flex justify-center items-center h-screen bg-gray-100">
            <div className="signup-box bg-white p-6 rounded shadow-md w-96">
                ...
                <button
                    onClick={handleSignup}
                    className="bg-pink-500 text-white p-2 rounded w-full hover:bg-pink-600 transition duration-200"
                >
                    Sign Up
                </button>
                <p className="login-link text-center mt-4">
